...
@Component({
  ...
  template: `
    <div class="container mx-auto p-4">
      ...
      <form [formGroup]="vectorStoreForm" (ngSubmit)="onSubmit()" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <a routerLink="/vector-stores" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
            Cancel
          </a>
        </div>
      </form>
