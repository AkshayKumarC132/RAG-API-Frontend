  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "vector-stores",
        loadChildren: () =>
          import("./features/vector-stores/vector-stores.routes").then(
            (m) => m.VECTOR_STORES_ROUTES
          ),
      },
      {
        path: "profile",
      ...
      },
      {
        path: "threads",
        loadChildren: () =>
          import("./features/threads/threads.routes").then(
            (m) => m.THREADS_ROUTES
          ),
      },
      {
      ...
      },
      {
        path: "api-keys",
        loadChildren: () =>
          import("./features/api-keys/api-keys.routes").then(
            (m) => m.API_KEYS_ROUTES
          ),
      },
      {
